...
pacman::p_load("readxl", "mapchina","rjson","rlist","mapchina")
```
...
# The underlying data of China map "ChinaMap" is to add South China Sea Islands and ten segment lines on the basis of the provincial data of R package mapchina. For more information, please see "china_map.R".
source("china_map.R", local = knitr::knit_global())
