...
pacman::p_load('geojsonsf', 'RColorBrewer', 'rgdal', 'mapproj', 'ggspatial', 'sf',"ggspatial",'naijR') # ggsn and maptools are not used.
pacman::p_load("readxl", "rjson", "rlist")
```
...
# below are commented code for the pre-processing map data
# source("china_map.R", local = knitr::knit_global())  
load(here::here("Re_Analysis_CHN.RData"))
# this file below contains the data of standard China map,  please see "china_map.R" for more information
# please contact the corresponding author if you encountered any difficulties in obtain the map by you own.
load(here::here("Re_Analysis_CHN2.RData")) 
...
df_cn_census_geo_adults_all <-   rbind(df_cn_census_geo_adults_all, SARs)
...
ChinaMap2 <- dplyr::left_join(ChinaMap, colour,by= "province")

# plot the main part
fig1d_1 <- ggplot2::ggplot() +
  ggplot2::geom_sf(data = ChinaMap2,
                   aes(geometry = geometry, 
                       fill = colour_psySample),
                   size = 0.0001, 
                   show.legend = TRUE) +
